...
const privateKeys = []; // enter your private keys here

const infuraKey = ""; // if your using ETH networks enter infura key here
//
// const fs = require('fs');
...
module.exports = {
    ...
    contracts_build_directory: "./frontend/src/app/abi",
